...
# # to check the alpabit small or large
# check_string = input("enter the alpabit to check")
# if check_string(a,b,c):
#     print("small")
# else:
# #     print("Capital")
...
#     print(f"value1 {value1}, is greater than {value2} and {value3}")
# elif value2> value1  and value2>value3:
#     print(f"value1 {value2}, is greater than {value1} and {value3}")
# elif value3 > value1  and value3>value2:
#     print(f"value1 {value3}, is greater than {value2} and {value1}")
# else:
#     exit()
...
# if plant_name.lower() == plant_name:
#         print("Yes - Spathiphyllum is the best plant ever!")
# elif plant_name.islower()== plant_name:
#         print("No, I want a big Spathiphyllum!")
# elif plant_name.capitlize()== plant_name:
# else:
